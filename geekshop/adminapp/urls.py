...
urlpatterns = [
    ...
    path('product/', ProductListView.as_view(), name='adminapp_product'),
    path('products-update/<int:pk>/', ProductsUpdateView.as_view(), name='adminapp_product_update'),
    path('products-create/', ProductsCreateView.as_view(), name='adminapp_product_create'),
    path('products-delete/<int:pk>/', ProductsDeleteView.as_view(), name='adminapp_product_delete'),
